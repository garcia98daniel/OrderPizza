    ...
    <>
      <section className="hero">
        <nav className="navBarIndex">
          <div className="brand">ENTRE AMIGOS</div>
        ...
        <div className="mainWords">
          ...
          <div className="star_container">
            <div className="stripeIndex">______________________</div>
      ...
      <section className="menu">
        ...
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quidem ipsam sint ab! Sapiente nesciunt magnam facilis officia aperiam officiis Quidem ipsam sint ab! Sapiente nesciunt magnam facilis officia aperiam officiis.</p>
      ...
      <footer>
          ...
          <div className="footer_text_container">
              ...
              <span>*</span>
              <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla corporis numquam velit? Aliquid reiciendis non iusto perferendis praesentium itaque nulla placeat nihil iste! Ab tempora autem doloribus reiciendis cum ullam.
              </p>
          </div>
          <div className="footer_section2">
              <div className="followUs">
                  ...
                  <div className="socialMedia">
                      <Link><img className="socialMedia_icon wa" src={fb_icon} alt="socialM_icon"/></Link>
                      <Link><img className="socialMedia_icon fb" src={ig_icon} alt="socialM_icon"/></Link>
                      <Link><img className="socialMedia_icon ig" src={fb_icon} alt="socialM_icon"/></Link>
                  </div>
              </div>
              <div className="contactUs">
              <h2>SUGERENCIAS</h2>
                <input type="text" placeholder="Email"/>
                <textarea placeholder="Dejanos tu mensaje" name="txtArea" id="" cols="20" rows="8"></textarea>
